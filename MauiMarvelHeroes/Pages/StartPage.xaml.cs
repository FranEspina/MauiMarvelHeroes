...
namespace MauiMarvelHeroes.Pages
{
    public partial class StartPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            //Heroes Animation
            parentAnimation.Add(0, 0.05, new Animation(v => imgCaptain.Opacity = v, 0, 1, Easing.CubicIn));
            parentAnimation.Add(0.05, 0.1, new Animation(v => imgHulk.Opacity = v, 0, 1, Easing.CubicIn));
            parentAnimation.Add(0.15, 0.2, new Animation(v => imgIronman.Opacity = v, 0, 1, Easing.CubicIn));
            parentAnimation.Add(0.25, 0.3, new Animation(v => imgLobezno.Opacity = v, 0, 1, Easing.CubicIn));
            parentAnimation.Add(0.30, 0.35, new Animation(v => imgThor.Opacity = v, 0, 1, Easing.CubicIn));

            parentAnimation.Add(0.35, 0.4, new Animation(x => imgCaptain.Scale = x, 1, 1.2, Easing.CubicIn));
            parentAnimation.Add(0.4, 0.45, new Animation(x => imgHulk.Scale = x, 1, 1.2, Easing.CubicIn));
            parentAnimation.Add(0.45, 0.5, new Animation(x => imgIronman.Scale = x, 1, 1.2, Easing.CubicIn));
            parentAnimation.Add(0.5, 0.55, new Animation(x => imgLobezno.Scale = x, 1, 1.2, Easing.CubicIn));
            ...
            //Intro Box Animation
            parentAnimation.Add(0.7, 1, new Animation(v => stackIntro.Opacity = v, 0, 1, Easing.CubicIn));
